...
try{
    ...
    Statement st = con.createStatement();
        ...
        String sql10="CREATE TABLE ticket(email varchar(30) PRIMARY KEY, fullname varchar(80), tel int, from1 varchar(100), to1 varchar(100), depdate varchar(100), deptime varchar(100), airline varchar(100), classtype varchar(100), adult int, children int, kids int, radio varchar(10), rdate varchar(100),rtime varchar(100),message varchar(500));";

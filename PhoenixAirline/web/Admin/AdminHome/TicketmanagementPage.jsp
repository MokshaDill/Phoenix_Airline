...
<body>
    <ul class="menu">
        ...
        <div class="text">
            ...
            <li class="item"><a><i class="fas fa-bell"></i>User's Accounts</a></li>
            <li class="item"><a><i class="fas fa-chart-line"></i>Ticket Information</a></li>
            <li class="item" style="background-color: #10707f"><a><i class="fas fa-bell"></i>Ticket management</a></li>
        </div>
    </ul>

    <br>

    <h1 style="text-transform: uppercase;" class="h">Ticket Management Panel</h1>
